	...
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<div class="eqLogicThumbnailContainer">
			...
			<div class="cursor eqLogicAction logoSecondary" data-action="gotoPluginConf">
                ...
                <legend><i class="fas fa-table"></i> {{Mes équipements EstarEnergy}}</legend>
		<?php
		if (count($eqLogics) == 0) {
                        echo '<br><div class="text-center" style="font-size:1.2em;font-weight:bold;">{{Aucun équipement EstarEnergy trouvé, cliquer sur "Ajouter" pour commencer}}</div>';
		} else {
			// Champ de recherche
